...
namespace STSdb4.Remote
{
    public class Descriptor : IDescriptor
    {
        ...
        public Descriptor(long id, string name, DataType keyDataType, DataType recordDataType)
            : this(id, name, STSdb4.Database.StructureType.XTABLE, keyDataType, recordDataType, DataTypeUtils.BuildType(keyDataType), DataTypeUtils.BuildType(recordDataType), DateTime.Now, DateTime.Now, DateTime.Now, null)
        {
        }
