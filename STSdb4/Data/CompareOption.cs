...
namespace STSdb4.Data
{
    public class CompareOption : IEquatable<CompareOption>
    {
        ...
        public static CompareOption Ascending
        {
            get { return new CompareOption(SortOrder.Ascending); }
        }

        public static CompareOption Descending
        {
            get { return new CompareOption(SortOrder.Descending); }
        }
    }
}
